                            ...
                            <h4>
                                <ul id="daily-index">
                                    ...
                                    foreach ($answered[1] as $index1 => $daily_answer) {
                                        ?>
                                        <li><a class="review_res" href="#" data-toggle="modal" data-target="#review_results" data-backdrop="static" data-index="<?= $index1 ?>" review_type="1"> <?= $course->course_name . $z++ ?></a></li>
                                        <?php
                                    }
                                    ?>
                                </ul>
                            ...
                            <h4>
                                <ul id="weekly-index">
                                    ...
                                    foreach ($answered[2] as $index2 => $weekly_answer) {
                                        ?>
                                        <li><a class="review_res" href="#" data-toggle="modal" data-target="#review_results" data-backdrop="static" data-index="<?= $index2 ?>" review_type="2"><?= $course->course_name . $z++ ?></a></li>
                                        <?php
                                    }
                                    ?>
                                </ul>
                            ...
                            <h4>
                                <ul id="monthly-index">
                                    ...
                                    foreach ($answered[3] as $index3 => $monthly_answer) {
                                        ?>
                                        <li><a class="review_res" href="#" data-toggle="modal" data-target="#review_results" data-backdrop="static" data-index="<?= $index3 ?>" review_type="3"><?= $course->course_name . $z++ ?></a></li>
                                        <?php
                                    }
                                    ?>
                                </ul>
