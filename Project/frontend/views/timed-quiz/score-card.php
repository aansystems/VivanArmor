            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header1 card-header-text" data-background-color="blue">
                        <h4 class="card-title text-uppercase">Score Card</h4>
                    </div>
                            ...
                            <table class="table table-striped table-no-bordered table-hover dataTable dtr-inline me" style="overflow-x: auto;">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $value) {
                                        $quiz_name = Subjects::findOne(['id' => $value->subject_id]);
                                        ?>
                                        <tr>
                                            <td class="text-center"><?= $i ?></td>
                                            <td> <?= $quiz_name->subject_name; ?></td>
                                            <td> <?= $quiz_name->quiz_name; ?></td>

                                            <td class="text-center">
                                                <div class="progress-circle p<?= $value->total_marks_obtained ?>">
                                                    <span><?= $value->total_marks_obtained ?>%</span>
                                                    <div class="left-half-clipper">
                                                        <div class="first <?= $value->total_marks_obtained ?>-bar"></div>
                                                        <div class="value-bar"></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center"> <?= $value->attempt; ?></td>
                                            <?php if ($value->total_marks_obtained < '50') : ?>
                                                <td class="text-center text-red text-uppercase"><button class="btn btn-sm btn-danger text-uppercase">Fail</button></td>
                                            <?php elseif ($value->total_marks_obtained >= '50') : ?>
