...
/* @var $searchModel frontend\models\StatesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'States Manager';
            ...
            <div class=" col-md-12">
                <div class="card">
                    <div class="card-header1 card-header-text" data-background-color="blue">
                        <h4 class="card-title">STATES MANAGER </h4>
                        <a href="<?= Yii::$app->request->baseUrl ?>/states/create">
