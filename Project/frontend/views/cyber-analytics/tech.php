            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header1 card-header-text" data-background-color="blue">
                        <h4 class="card-title text-uppercase">Technical Index</h4>
                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="card <?php
                                ...
                                <div class="card-footer">
                                    <h6 class="text-center template-name"> <?= $array['data']->template_name ?></h6>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
...
<script>
    ...
    $(function () {
        ...
        // The Learning index
        var technical_index = Highcharts.chart('technical_index', Highcharts.merge(gaugeOptions, {
            yAxis: {
                min: 0,
                max: 100,
                title: null
