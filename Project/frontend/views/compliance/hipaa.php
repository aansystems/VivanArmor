...
<style>
    ...
    div.horizontal-tab-menu div.list-group{
        margin-bottom: 0;
    }

    div.horizontal-tab-menu div.list-group>a{
        margin-bottom: 0;
        color: #000000;
        font-weight: 500 !important;
        width: 37.46%;
    ...
    div.horizontal-tab-menu div.list-group>a .glyphicon,
    div.horizontal-tab-menu div.list-group>a .fa {
        color: #7B7B7B;
    }

    div.horizontal-tab-menu div.list-group>a:first-child {
        border-top-right-radius: 0;
        -moz-border-top-right-radius: 0;
    }

    div.horizontal-tab-menu div.list-group>a:last-child {
        border-bottom-right-radius: 0;
        -moz-border-bottom-right-radius: 0;
    }

    div.horizontal-tab-menu div.list-group>a.active,
    div.horizontal-tab-menu div.list-group>a.active .glyphicon,
    div.horizontal-tab-menu div.list-group>a.active .fa {
        color: #ffffff;
    }

    div.horizontal-tab-menu div.list-group>a.active:after {
        content: '';
        position: absolute;
        left: 45%;
        top: 50%;
    ...
    div.horizontal-tab-content {
        background-color: #ffffff;
    }

    div.horizontal-tab div.horizontal-tab-content:not(.active), div.horizontal-tab:not(.active) {
        display: none;
    }
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header1 card-header-text" data-background-color="blue">
                        <h4 class="card-title text-uppercase">HIPAA Dashboard</h4>
                    </div>
                    <div class="card-content">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 vertical-tab-container">
                                <div class="col-lg-12 col-md-12 col-sm-12 horizontal-tab-menu">
                                    <div class="list-group" style="display:flex">
                                        <a href="#" class="list-group-item hide text-center active">
                                            ...
                                            <h6 class="text-capitalize">HIPAA Controls</h6>
                                        </a>
                                        <?php foreach ($category as $cat) { ?>
                                            <a href="#" class="list-group-item color-grey text-center">
                                                <i class="fa <?= $cat->fa_icon ?> fa-2x"></i><br/>
                                                <h6 class="text-capitalize"><?= $cat->category_name ?></h6>
                                            </a>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 horizontal-tab active no-padding">
                                    <div class="horizontal-tab-content active">
                                        <div class="board">
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active process-pane text-center">
                                                    <img style="max-height: 40rem; width: 92% !important;" src="<?= Yii::$app->request->baseUrl ?>/images/hipaa.png" alt="" width="100%">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <?php foreach ($category as $cat) { ?>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 horizontal-tab no-padding">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 vertical-tab-container">
                                                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-3 vertical-tab-menu">
                                                    <div class="list-group">
                                                        ...
                                                        <?php foreach ($array1[$cat->id] as $array) {
                                                            ?>
                                                            <a href="#" id="policy_<?= $array['data']->id ?>"  data-id="<?= $cat->id ?>" class="list-group-item text-center 
                                                            <?php
                                                ...
                                                <div class="col-lg-10 col-md-9 col-sm-9 col-xs-9 vertical-tab">
                                                    <div class="vertical-tab-content cat-<?= $cat->id ?> active">
                                                        <section>
                                                            <div class="row">
                                                                <div class="board">
                                                                    <div class="tab-content">
                                                                        <div class="tab-pane fade in active process-pane">
                                                                            <img src="<?= Yii::$app->request->baseUrl ?>/images/hipaa.png" alt="" width="100%">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <?php
                                                foreach ($array2[$cat->id] as $array) {
                                                    ?>
                                                    <div class="col-lg-10 col-md-9 col-sm-9 col-xs-9 vertical-tab">
                                                        <div class="vertical-tab-content cat-<?= $cat->id ?>">
                                                            <section>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="board">
                                                                        <div class="board-inner">
                                                                            <ul class="nav nav-tabs" id="myTab">
                                                                                ...
                                                                                <li>
                                                                                    <a href="#status_<?= $array['data']->id ?>" data-toggle="tab" title="status">
                                                                        ...
                                                                        <div class="tab-content">
                                                                            ...
                                                                            <div class="tab-pane fade" id="status_<?= $array['data']->id ?>">
                                                                                ...
                                                                                <div class="row div-status" id="status_log_<?= $array['data']->id ?>">
                                                                                    <?php
...
<script>
    $(document).ready(function () {
        $("div.vertical-tab-menu>div.list-group>a").click(function (e) {
            ...
            console.log(index);
            console.log($("div.vertical-tab>div.cat-" + cat));
            $("div.vertical-tab>div.cat-" + cat).removeClass("active");
            $("div.vertical-tab>div.cat-" + cat).eq(index).addClass("active");
        });
        $("div.horizontal-tab-menu>div.list-group>a").click(function (e) {
            e.preventDefault();

            $('.card img').css('height', '400px');

            $(this).siblings('a.active').removeClass("active");
            $(this).addClass("active");
            var index = $(this).index();
            $("div.horizontal-tab").removeClass("active");
            $("div.horizontal-tab").eq(index).addClass("active");
            $("div.horizontal-tab>div.horizontal-tab-content").removeClass("active");
            $("div.horizontal-tab>div.horizontal-tab-content").eq(index).addClass("active");
        });
    });
