...
/**
 * CsoTemplatesSearch represents the model behind the search form of `frontend\models\CsoTemplates`.
 */
class CsoTemplatesSearch extends CsoTemplates
{
    /**
     * @inheritdoc
     */
