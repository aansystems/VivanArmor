...
/**
 * MasterDocTemplatesSearch represents the model behind the search form of `frontend\models\MasterDocTemplates`.
 */
class MasterDocTemplatesSearch extends MasterDocTemplates
{
    /**
     * @inheritdoc
     */
