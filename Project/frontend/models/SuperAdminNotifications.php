...
/**
 * This is the model class for table "super_admin_notifications".
 *
 * @property int $id
 ...
 */
class SuperAdminNotifications extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'super_admin_notifications';
    }
    ...
    {
        return [
            [['assigned_from', 'message', 'start_date', 'end_date', 'created_by', 'created_at', 'updated_by', 'updated_at'], 'required'],
