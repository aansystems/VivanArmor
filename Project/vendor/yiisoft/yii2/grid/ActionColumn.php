            ...
            $this->buttons[$name] = function ($url, $model, $key) use ($name, $iconName, $additionalOptions) {
                switch ($name) {
                    case 'view':
                        ...
                        $css=Yii::t('yii','btn btn-primary btn-simple waves-effect');
                        break;
                    case 'update':
                        $title = Yii::t('yii', 'Update');
                        $css=Yii::t('yii','btn btn-success btn-simple waves-effect');
                        break;
                    case 'delete':
                        $title = Yii::t('yii', 'Delete');
                        $css=Yii::t('yii','btn btn-danger btn-simple waves-effect');
                        break;
                    default:
                        $title = ucfirst($name);
                }
